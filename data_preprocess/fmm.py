...
input_label_dir = r'C:\Users\65344\Desktop\dataset1\test\labels/'
output_label_dir = r'C:\Users\65344\Desktop\dataset1_after_fmm\test\labels/'
if not os.path.exists(output_label_dir):
    os.mkdir(output_label_dir)
label_name_list = os.listdir(input_label_dir)

with open('C:/Users/65344/PycharmProjects/deep-learning-course-repo-master/data_preprocess/vocab.txt', 'r', encoding='utf-8') as f:
    vocab = f.read().split()
...
with open(r'C:\Users\65344\Desktop\dataset1_after_fmm\cn_vocab.txt', 'a', encoding='utf-8') as f:
